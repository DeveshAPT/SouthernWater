...
public class RegistrationFunctions {
	...
	{
		boolean flag=false;
		List<WebElement> elements=pageDriver.getwebelements(custRegist.getlocator("//locators/TermsAndConditionsLink"));
		flag=elements.size()>0?true:false;
	...
	{
		List<WebElement> elements1=pageDriver.getwebelements(custRegist.getlocator("//locators/TermsAndCondtionHeading"));
		...
		List<WebElement> elements5=pageDriver.getwebelements(custRegist.getlocator("//locators/TermsAndConditionClose"));
	...
	public void CloseTermAndConditionPage() throws Exception
	{
		...
		Assert.assertTrue(pageDriver.IsPresent((custRegist.getlocator("//locators/TermsAndConditionClose"))), "Close button not found");
	}
	...
	{
		pageDriver.SafeJavaScriptClick(pageDriver.getwebelement(custRegist.getlocator("//locators/AgreeTermsCheckBox")));
	...
	{
		List<WebElement> elements1=pageDriver.getwebelements(custRegist.getlocator("//locators/AcceptTermMessageSecond"));
		boolean flag1=elements1.size()>0?true:false;
	...
	public void EnterCustomerDetials(String  CustomerNumber,String LastName, String Email) throws InterruptedException, IOException, DocumentException
	{
		enteredName=LastName;
		enteredCustomerNumber=CustomerNumber;
		enteredEmailID=Email;
		pageDriver.SendKeys(pageDriver.getwebelement(custRegist.getlocator("//locators/CustomerNumber")),CustomerNumber);
		pageDriver.SendKeys(pageDriver.getwebelement(custRegist.getlocator("//locators/LastName")),LastName);
		pageDriver.SendKeys(pageDriver.getwebelement(custRegist.getlocator("//locators/EmailId")),Email);
	}
	...
	{
		Assert.assertTrue(pageDriver.IsPresent(custRegist.getlocator("//locators/YourDetails")),"Your Details Page is not open");
	}
	...
	public void EnterEmailID(String UpdateEmail) throws InterruptedException, IOException, DocumentException
	{
		...
		Thread.sleep(5000);
		pageDriver.CleasrAndSendKeys(pageDriver.getwebelement(custRegist.getlocator("//locators/EmailId")),UpdateEmail+Keys.TAB);
	}
	...
	public void FirstQuestionAnswer(String firstQuestion, String firstAnswer) throws InterruptedException, IOException, DocumentException
	{
	...
	public void SecondQuestionAnswer(String secondQuestion, String secondAnswer) throws InterruptedException, IOException, DocumentException
	{
		...
		pageDriver.SendKeys(pageDriver.getwebelement(custRegist.getlocator("//locators/SecondAnswer")),secondAnswer);
		Thread.sleep(5000);
	}
	...
	public void ActivationMailMessageVerify() throws Exception
	{
		...
		Assert.assertTrue(pageDriver.IsPresent((custRegist.getlocator("//locators/VerifyEmailMessage"))),"'Verify your email address' not depict on screen");
		
		List<WebElement> Messages=pageDriver.getwebelements(custRegist.getlocator("//locators/VerifyEmailMessageList"));
